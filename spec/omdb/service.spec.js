describe('omdb service', function(){
	...
	it('should return seach movie data', () => {
		var response;
		var expectedUrl = url => url.indexOf('http://www.omdbapi.com') !== -1;
		...
		$httpBackend.flush();
		expect(responce).toEqual(movieData);
	});
	...
	it('should return movie data by id', () => {
		...
		expect(responce).toEqual(movieDataById);
	});
